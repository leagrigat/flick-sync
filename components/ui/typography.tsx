	...
	(props, ref) => {
		return (
			<h1
				...
				ref={ref}
				className={cn(
					'scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl text-slate-800',
					props.className
				)}>
				{props.children}
			</h1>
	...
	(props, ref) => {
		return (
			<p
				{...props}
				ref={ref}
				className={cn('leading-relaxed [&:not(:first-child)]:mt-6 text-gray-700', props.className)}>
				{props.children}
			</p>
		);
	}
