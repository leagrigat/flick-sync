  ...
  return (
    <>
      <div className="w-screen h-screen flex flex-col items-center py-16 gap-8">
        ...
        <P className="font-medium max-w-2xl text-center">Your ultimate movie night companion. Create groups, announce
          screenings, track watched films, and share reviews — all in one place.
          Connect and enjoy cinema with friends like never before!</P>
        <CreateGroup />
